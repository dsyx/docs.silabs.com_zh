...
* [x] [UG438: GATT Configurator User's Guide for Bluetooth SDK v3.x and Higher](UG438/GATT%20Configurator%20User%E2%80%99s%20Guide%20for%20Bluetooth%20LE%20and%20Bluetooth%20Mesh.md) - 描述了如何使用 Simplicity Studio 5 的 GATT Configurator，这是一个直观的界面，可以访问 Bluetooth Specification 中定义的所有 Profiles、Services、Characteristics 和 Descriptors。
